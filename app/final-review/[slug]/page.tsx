...
export async function generateStaticParams() {
  const slugs = getAllNoteSlugs("final-review");
...
export async function generateMetadata({
  ...
  const note = getNoteBySlug("final-review", params.slug);
...
export default async function NotePage({
  ...
  const mdxSource = getNoteContent("final-review", params.slug);
  ...
  const allNotes = getAllNotes("final-review").filter((n): n is NoteMeta => n !== undefined);
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/final-review" className="co-note-button">
          {"<-"} final review
        </Link>
      ...
      >
        {prevNote ? (
          <Link
            href={`/final-review/${prevNote.slug}`}
        ...
        {nextNote ? (
          <Link
            href={`/final-review/${nextNote.slug}`}
            className="co-note-nav-card"
