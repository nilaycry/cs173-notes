...
export async function generateStaticParams() {
  const slugs = getAllNoteSlugs("combinatorics");
...
export async function generateMetadata({
  ...
  const note = getNoteBySlug("combinatorics", params.slug);
...
export default async function NotePage({
  ...
  const mdxSource = getNoteContent("combinatorics", params.slug);
  ...
  const allNotes = getAllNotes("combinatorics").filter((n): n is NoteMeta => n !== undefined);
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/combinatorics" className="co-note-button">
          {"<-"} notes
        </Link>
